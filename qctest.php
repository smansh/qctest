...
<link rel="stylesheet" href="css/button_status.css">
      ...
      <header class="site-navbar site-navbar-target py-4" role="banner">
        ...
        <div class="container1">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-5">
              <div class="site-logo11">
                <a href="" class="font-weight-bold text-white"><img src="images/logo.png"></a>
              </div>
            </div>
            ...
            <div class="col-5  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-none" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="qctest.php" class="nav-link">Home</a></li>
...
<div class="hero" style="background-color:#c3bebb;"><?php echo $ip_address;?></div>


  <h3 align="center"> QC-Test: TR-CES2708F</h3>

<img  class="center" width="30%" height="10%" src="images/ces-700_1.jpg">

<form  id="frm1" name="frm"  method="post" onsubmit="return process()" action="qctest.php"  > 
...
<button class="button-one" type="submit" name="submit" id="test">Test</button>
  ...
  <img  id="img" class="center2" width="60px" height="40px" src="">

    <div id="Container">
        <div id="led-gray1"></div>
        <div id="led-gray2"></div>
        <div id="led-gray3"></div>
        <div id="led-gray4"></div>
        <div id="led-gray5"></div>
        <div id="led-gray6"></div>
        <div id="led-gray7"></div>
        <div id="led-gray8"></div>
...
$result = $telnet->Connect($ip_address);
...
$serial_no=substr("$data",324,11);
//echo "<br>";

$str2="MAC Address";
$pos2= strpos($data,$str2);
$mac_address=substr("$data",495,18);
//echo "<br>";
...
{
?>
        <div id="<?php echo $class1;?>"></div>
        <div id="<?php echo $class2;?>"></div>
        <div id="<?php echo $class3;?>"></div>
        <div id="<?php echo $class4;?>"></div>
        <div id="<?php echo $class5;?>"></div>
        <div id="<?php echo $class6;?>"></div>
        <div id="<?php echo $class7;?>"></div>
        <div id="<?php echo $class8;?>"></div>
...
<?php
$ver="G0/1- up,G0/2- up,G0/3- up,G0/4- up,G0/5- up,G0/6- up,G0/7- up,G0/8- up";

?>
<br>
<div id="div">
    <label for="input_box"> </label><input type="text" class="tb1" id="port_status" name="port_status"  size="90" value='<?php echo $port;?>' />
</div>
<br>
...
var port_status=document.forms["frm"]["port_status"].value;

if (serial_no==null ||  serial_no=="" || mac_address==null || mac_address=="" || version==null || version=="" || port_status=="") {
      document.getElementById('btSubmit').disabled = true; 
